...
func (u *Auth) SaveUser(ctx context.Context, email string, pass string) (uid int64, err error) {
	u.log.Info("saveUSER service", email, pass)
...
func (u *Auth) GenerateJWT(ctx context.Context, user models.User) (string, error) {
...
func (u *Auth) ValidateJWT(ctx context.Context, tokenString string) (models.User, error) {
	claims := &Claims{}
	...
	user, err := u.GetUser(ctx, claims.Email)
	if err != nil {
